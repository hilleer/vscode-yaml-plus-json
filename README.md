...
| `directoryConversion`    | Enable the right-click commands that convert all JSON/YAML files in a directory. Set to `false` to hide them from the explorer context menu.                                                                | boolean | `true`    | `false`    |
